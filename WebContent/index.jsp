...
<body>
	<div style="padding-left:50px;font-family:monospace;">
		...
		<a href="${pageContext.request.contextPath}/rest/userInfo"><div style="color:saffron">Get User details</div></a></br></br>
		<a href="${pageContext.request.contextPath}/update.jsp"><div style="color:saffron">Update User</div></a></br></br>
